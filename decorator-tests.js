...
const tests = {
  ...
  "Initializer order (private members)": () => {
    ...
    @classDec1 @classDec2 class Foo extends (log.push("extends"), Object) {
      ...
      @fieldDec1 @fieldDec2 #field;
      @staticFieldDec1 @staticFieldDec2 static #staticField;
      @getterDec1 @getterDec2 get #getter() {
        return;
      }
      @staticGetterDec1 @staticGetterDec2 static get #staticGetter() {
        return;
      }
      @setterDec1 @setterDec2 set #setter(x) {
      }
      @staticSetterDec1 @staticSetterDec2 static set #staticSetter(x) {
      }
      @accessorDec1 @accessorDec2 accessor #accessor;
      @staticAccessorDec1 @staticAccessorDec2 static accessor #staticAccessor;
      static {
        log.push("static:end");
      }
    }
